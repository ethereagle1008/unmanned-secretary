                            ...
                            <form class="form" id="save_form">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            <label for="user-id" class="col-sm-2 col-form-label-lg"
                                                   style="padding-right: 0">ID <span class="color-red-tmp">*</span></label>
                                            <div class="col-sm-10" style="padding-left: 0">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        @if(isset($user))
                                            <button type="reset" class="btn btn-dark waves-effect waves-float waves-light me-1" onclick="event.preventDefault();deleteData({{$user->id}}, '{{route('company.client-delete')}}')" tabindex="13">{{__('delete')}}</button>
                                        @endif
