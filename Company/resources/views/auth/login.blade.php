            ...
            <div class="d-flex col-lg-12 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 px-xl-2 mx-auto">
                    ...
                    <a class="brand-logo" href="">
                        <img src="{{asset('icon').'/logo.png'}}" style="width: 100px">
                    </a>
                    <!-- /Brand logo-->
                    <h2 class="card-title fw-bold mb-1 text-center">{{__('manager-title')}}<br>{{__('company-system')}}</h2>
                    ...
                    <form class="auth-login-form mt-2" id="login_form" action="{{ route('login') }}" method="POST" style="margin-top: 50px !important;">
                        ...
                        <div class="mt-0 text-center">
                            <p>{{__('password-forget')}}</p>
                        </div>
                        <div class="d-flex mt-2">
                            <button class="btn btn-danger" tabindex="4" style="margin: auto" onclick="event.preventDefault(); refreshToken();">{{__('login')}}</button>
                        </div>
