...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('password-change', [ApiController::class, 'passwordChange'])->name('api.password-change');
    ...
    Route::post('get-report-total', [ApiController::class, 'getReportTotal'])->name('api.get-report-total');
