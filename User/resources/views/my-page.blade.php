                                    ...
                                    <form class="form" id="save_form">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-10" style="padding-left: 0">
                                                        <select class="form-select" id="type" name="type" tabindex="2" data-index="2">
                                                            <option value="1" {{$user->type == 1 ? 'selected' : ""}}>{{__('co-op')}}</option>
                                                            <option value="2" {{$user->type == 2 ? 'selected' : ""}}>{{__('solo-pro')}}</option>
                                                            <option value="3" {{$user->type == 3 ? 'selected' : ""}}>{{__('alone')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <button type="button" class="btn btn-primary me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('client.edit-info')}}', false)" tabindex="13">{{__('edit')}}</button>
