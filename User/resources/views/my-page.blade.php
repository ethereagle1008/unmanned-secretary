                            ...
                            <form class="form" id="save_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <select class="form-select" id="type" name="type" tabindex="2" data-index="2" disabled>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="button" class="btn background-sky color-white me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('client.edit-info')}}', false)" tabindex="13">{{__('edit')}}</button>
