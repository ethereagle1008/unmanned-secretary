        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="{{ str_contains(\Request::route()->getName(), 'cost') ? 'active' : '' }} nav-item">
                <a class="d-flex align-items-center" href="{{route('client.cost-manage')}}">
                    <i data-feather="book"></i><span class="menu-title text-truncate" data-i18n="{{__('cost-manage')}}">{{__('cost-manage')}}</span>
                </a>
            </li>
            <li class="{{ str_contains(\Request::route()->getName(), 'account') ? 'active' : '' }} nav-item">
                <a class="d-flex align-items-center" href="{{route('client.account-manage')}}">
