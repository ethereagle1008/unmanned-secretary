                                ...
                                <div class="row mt-0">
                                    <div class="mb-0 col-md-6">
                                        <div class="mb-0 row">
                                            ...
                                            <div class="col-sm-10" style="padding-left: 0">
                                                @if(!empty($data['url']))
                                                    <img class="mb-0" style="margin-top: 10px; max-width: 50%; height: auto" src="{{asset('upload').'/'.$data['url']}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
{{--                                        <button type="button" class="btn btn-primary me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('client.client-save')}}')" tabindex="12">{{__('register')}}</button>--}}
                                        <button type="reset" class="btn btn-dark waves-effect waves-float waves-light me-1" onclick="event.preventDefault();deleteData({{$data->id}}, '{{route('client.cost-delete')}}')" tabindex="13">{{__('delete')}}</button>
