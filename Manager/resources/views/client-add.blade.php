                        ...
                        <div class="card-body border-bottom">
                            <div
                                ...
                                <div class="col-sm-12 col-lg-4 d-flex justify-content-center justify-content-lg-start">
                                    <h4 class="card-title mb-0">{{__('client-add')}}</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="form" id="save_form">
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-10" style="padding-left: 0">
                                                <input type="number" id="post-code" class="form-control" name="post_code" placeholder="" value="{{isset($user) ? $user->post_code : ''}}" minlength="7" required tabindex="5" data-index="5"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="button" class="btn btn-primary me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('manager.client-save')}}')" tabindex="12">{{__('register')}}</button>
                                        @if(isset($user))
                                            <button type="reset" class="btn btn-dark waves-effect waves-float waves-light me-1" onclick="event.preventDefault();deleteData({{$user->id}}, '{{route('manager.client-delete')}}')" tabindex="13">{{__('delete')}}</button>
                                        @endif
