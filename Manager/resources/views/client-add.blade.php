                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="text" id="company-code" class="form-control" placeholder=""
                                                       value="{{isset($user) ? $user->user_code : $code}}" tabindex="1"/>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="text" id="client-name" class="form-control" name="name" placeholder=""
                                                       value="{{isset($user) ? $user->name : ''}}" required tabindex="2"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="email" id="user-id" class="form-control" name="email" placeholder=""
                                                       value="{{isset($user) ? $user->email : ''}}" required tabindex="3"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-1 col-md-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-3 ps-0">
                                                <input type="number" id="post_code_zip" class="form-control" name="post_code" placeholder=""
                                                       value="{{isset($user) ? $user->post_code : ''}}" minlength="7" required tabindex="5"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-1 col-md-12">
                                    ...
                                    <div class="mb-1 col-md-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9" style="padding-left: 0">
                                                <textarea rows="5" id="remarks" class="form-control" name="remarks" placeholder="" tabindex="11"
                                                          data-index="11">{{isset($user) ? $user->remarks : ''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                        <button type="button" class="btn btn-primary me-1 btn_submit"
onclick="event.preventDefault();saveForm('{{route('manager.client-save')}}')" tabindex="12">{{__('register')}}</button>--}}
{{--                                        @if(isset($user))--}}
