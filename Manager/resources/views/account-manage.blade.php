                                                    ...
                                                    <form class="dt_adv_search" method="POST" id="change_form">
                                                        ...
                                                        <div class="d-flex mt-1">
                                                            <button type="button" class="btn btn-flat-primary d-grid w-100 me-1"
                                                                    onclick="event.preventDefault();changeForm('{{route('manager.change-account-type')}}')">{{__('save')}}</button>
                                ...
                                <div class="row g-1 mb-md-0">
                                    ...
                                    <div class="col-md-2">
                                        <button class="btn btn-success mr-2" id="btn_get_table"
                                                onclick="event.preventDefault();getTableData('{{route('manager.account-table')}}')">{{__('search')}}
                                        </button>
                                    </div>
                                    <div class="col-md-4">
                                        <div
