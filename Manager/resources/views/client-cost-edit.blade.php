                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="mb-0 col-md-6">
                                        <div class="mb-0 row" style="height: 100%;">
                                            ...
                                            <div class="col-sm-9">
                                                @if(!empty($data['url']))
                                                    <img class="d-none" id="image" src="{{'https://e-strongest.jp/user/public/upload/'.$data['url']}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
{{--                                           href="{{route('manager.cost-export-pdf', $data->id)}}">--}}
{{--                                            <i data-feather='download'></i>{{__('report')}}--}}
{{--                                        </a>--}}
                                        <button type="button" class="btn btn-primary me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('manager.client-cost-save')}}')" tabindex="12">{{__('register')}}</button>
                                        <button type="reset" class="btn btn-dark waves-effect waves-float waves-light me-1" onclick="event.preventDefault();deleteData({{$data->id}}, '{{route('manager.client-cost-delete')}}')" tabindex="13">{{__('delete')}}</button>
        ...
        const viewer = new Viewer(image, {
            ...
            toolbar: {
                ...
                download: async function () {
                    console.log(viewer.image.src)
                    const image = await fetch(viewer.image.src)
