                            ...
                            <form class="form" id="save_form">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="button" class="btn btn-primary me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('manager.company-save')}}')" tabindex="13">{{__('register')}}</button>
                                        @if(isset($user))
                                            <button type="reset" class="btn btn-dark waves-effect waves-float waves-light me-1" onclick="event.preventDefault();deleteData({{$user->id}}, '{{route('manager.company-delete')}}')" tabindex="14">{{__('delete')}}</button>
                                        @endif
