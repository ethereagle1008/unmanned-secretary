                            ...
                            <form class="form" id="save_form">
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="text" id="company-code" class="form-control" placeholder="" value="{{isset($user) ? $user->user_code : $code}}" tabindex="1" disabled/>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="text" id="company-name" class="form-control" name="name" placeholder="" value="{{isset($user) ? $user->name : ''}}" required tabindex="2"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 0">
                                                <input type="password" id="user-id" class="form-control" name="password" placeholder="" {{isset($user) ? '' : 'required'}} minlength="8" tabindex="4"/>
                                            </div>
                                            <label class="col-sm-4 ps-0" style="padding-top: 10px">{{__('half-string')}}</label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="button" class="btn btn-dark me-1 btn_submit" onclick="event.preventDefault();saveForm('{{route('manager.company-save')}}')" tabindex="13">{{__('register')}}</button>
                                        @if(isset($user))
