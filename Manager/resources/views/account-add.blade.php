                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-10" style="padding-left: 0">
                                                <select class="form-select" id="type" name="type" tabindex="2" data-index="2">
                                                    <option value="1" {{isset($account) && $account->type == 1 ? 'selected' : ''}}>{{__('co-op')}}</option>
                                                    <option value="2" {{isset($account) && $account->type == 2 ? 'selected' : ''}}>{{__('solo-pro')}}</option>
                                                    <option value="3" {{isset($account) && $account->type == 3 ? 'selected' : ''}}>{{__('alone')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
