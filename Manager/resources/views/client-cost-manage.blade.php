                                    ...
                                    <div
                                        ...
                                        <div class="dt-buttons">
                                            <button type="button" class="dt-button add-new btn btn-primary" id="cost_export_excel"
                                                    onclick="event.preventDefault();exportFile('{{route('manager.cost-export-csv')}}', 'csv', '{{trim($account_type)}}')">
                                                <i data-feather='download'></i>{{__('export')}}
                                            </button>
{{--                                            <a type="button" class="dt-button add-new btn btn-primary" id="cost_export_pdf"--}}
{{--                                               href="{{route('manager.client-cost-export-pdf', $user->id)}}">--}}
...
{{--                        </div>--}}
    ...
    <script>
        addEventListener('pageshow', (event) => {
            getTableData('{{route('manager.client-cost-table')}}');
        });
    </script>
</x-app-layout>
